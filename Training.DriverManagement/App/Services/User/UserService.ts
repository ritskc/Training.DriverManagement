module DriverManagement
{
    export class LocalUserService implements IUserService
    {
        ...
        public GetUsers(): Ext.IList<User>
        {
            return this._users.Where(t => !t.IsDeleted);
        }
        ...
        public UpdateUser(id: number, email: string, firstname: string, lastname: string, phoneno: string): void
        {
            if (id == null)
